...
const Footer = () => {
  return (
    <footer className="px-6 lg:px-16 divide-y bg-gray-900 text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-8 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-gray-50">Service</h3>
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        ...
        <Link className="text-blue-400">Sazal</Link>
      </div>
    </footer>
  );
};
