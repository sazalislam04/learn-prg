      ...
      <div>
        <Pdf targetRef={ref} filename="code-example.pdf">
          {({ toPdf }) => (
            <button
              onClick={toPdf}
              className="px-4 py-2 ml-20 flex items-center text-white bg-red-500 rounded"
            >
              Download Pdf <FaFileDownload className="ml-1" />
            </button>
          )}
        </Pdf>
        <div ref={ref}>
          <div className="px-6 lg:px-12 container md:flex justify-between mx-auto gap-y-6 md:gap-10">
                  ...
                  <div className="container flex flex-col w-full max-w-lg divide-y rounded-md divide-gray-600">
                    ...
                    <div className="p-4 space-y-2 text-sm text-gray-600">
                      ...
                      <p>
                        ...
                        vitae accumsan feugiat. Vestibulum commodo, ante sit
                        urna purus rutrum sem.
                      </p>
                    </div>
                  </div>
                  <div className="pt-8">
            ...
            <div className="sticky top-20 rounded h-[550px] mt-5 lg:mt-0">
              <div className="">
                ...
                <div className="p-5">
                  <h5 className="text-2xl font-semibold text-red-500">
                    {price}$
                  </h5>
                </div>
                <div className="mt-4">
